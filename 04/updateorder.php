...
<div class="wrap" id="wrap">
    <fieldset>
        ...
        <table border="0px" cellspacing="20px" cellpadding="5px">
            ...
            echo "<tr><td>商品名（书名）</td><td>用户名</td><td>地址</td><td>电话号码</td><td>订单状态</td><td>操作</td><td></td></tr>";
            //$row = mysqli_fetch_array($rs);
            while ($row = mysqli_fetch_row($rs)) {
                echo "<tr><td>《$row[1]》</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td><td><a href='updateorder2.php?id=$row[0]' >修改订单状态</a></td><td></td></tr>";
            }
            ?>
        </table>
    </fieldset>
