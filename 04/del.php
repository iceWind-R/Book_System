...
<fieldset>
    <legend><font color="blue">商品删除</font></legend>
    <p>
    ...
    <table border="0px"cellspacing="20px" cellpadding="5px">
        ...
        echo "<tr><td>商品名（书名）</td><td>价格</td><td>库存</td><td>操作</td><td></td><td></td><td></td></tr>";
        while($row = mysqli_fetch_row($rs)){
            echo "<tr><td>《$row[1]》</td><td>$row[2]</td><td>$row[4]</td><td><a href='del2.php?id=$row[1]' >删除</a></td><td></td></tr>";
        }
        ?>
    </table>
</fieldset>
